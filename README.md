...
我們使用了 `pandas` 與 `sqlite3` 建立了資料庫，利用 `numpy` 進行概念驗證並以 `gradio` 做出成品，可以點選 Hugging Face 的連結 <https://huggingface.co/spaces/Leoni-Ts/taiwan_presidential_election_2024> 參考成品。
